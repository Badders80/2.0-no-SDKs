      ...
      <div className='mx-auto max-w-[1200px] px-10 sm:px-16 py-24'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-10'>
          ...
          <div className='lg:col-span-3 lg:flex lg:items-center lg:justify-end'>
            <div className='text-left lg:text-right'>
              <p className='text-sm tracking-[0.2em] uppercase text-white/70 mb-3'>Accredited By</p>
              <img
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10'>
          <div>
            ...
            <ul className='space-y-2 text-gray-300'>
              <li>
                <a href='#mission' className='hover:text-brand-gold'>
                  Our Mission
                </a>
              </li>
              <li>
                <a href='#about' className='hover:text-brand-gold'>
                  About
                </a>
              </li>
              <li>
                <a href='#innovation' className='hover:text-brand-gold'>
                  Innovation
                </a>
              </li>
              <li>
                <a href='#mystable' className='hover:text-brand-gold'>
                  MyStable
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className='space-y-2 text-gray-300'>
              <li>
                <a href='#docs' className='hover:text-brand-gold'>
                  Documentation
                </a>
              </li>
              <li>
              ...
              <li>
                <a href='#changelog' className='hover:text-brand-gold'>
                  Changelog
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className='space-y-2 text-gray-300'>
              <li>
                <a href='#privacy' className='hover:text-brand-gold'>
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href='#terms' className='hover:text-brand-gold'>
                  Terms of Service
                </a>
              </li>
              <li>
                <a href='#license' className='hover:text-brand-gold'>
                  Private License
                </a>
              </li>
            </ul>
        ...
        <div className='mt-12 flex flex-col items-center gap-4'>
          ...
          <div className='flex items-center gap-6 text-gray-400'>
            ...
            <a href='https://x.com' aria-label='X' className='hover:text-brand-gold'>
              X
            </a>
            <a
