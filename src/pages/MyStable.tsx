  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="pt-24 px-6 md:px-20 max-w-7xl mx-auto">
        ...
        {/* Portfolio Overview */}
        <Card
          style={{ backgroundColor: '#1f2937', border: '1px solid #374151', marginBottom: '2rem' }}
        >
                ...
                <div style={{ padding: '1.5rem' }}>
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      ...
                      <Typography style={{ color: '#9ca3af' }}>Trainer: {horse.trainer}</Typography>
                    </div>
                    <div
        ...
        <Card
          style={{
            background:
              'linear-gradient(to right, rgba(212, 169, 100, 0.2), rgba(234, 179, 8, 0.2))',
